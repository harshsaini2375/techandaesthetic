    ...
    <div >
      ...
      <div className="home md:flex">
        <div className="left h-[57vh] md:h-[94vh] w-2/4 md:w-1/4  bg-[#6a9097]  relative">
          <div className="circle border-[10px] md:border-[15px] border-white h-[300px] w-[300px] md:h-[450px] md:w-[450px] rounded-full relative top-[6vh] left-[12vw] md:top-[15vh] md:left-[9vw] bg-gray-300 overflow-hidden  " ><Image className="absolute object-cover object-right-top"  src={"/introemp.jpeg"} alt="introimg" fill={true}/></div>
        </div>
